 ...
 * such that it can be used interchangeably with other network
...
protected:
   ...
   *
   * Specialized for ONNX to print the input and output nodes with their
   * dimensions.
   *
...
private:
   ...
   * It's a vector<char> rather than a string because we need the guarantee
   ...
   *
   * The m_session variable is initialized from the m_bytes variable
  ...
  std::vector<Ort::AllocatedStringPtr>
      m_storeInputNodeNames;  //! Do not persistify
#endif
   ...
   **/
  std::vector<Ort::AllocatedStringPtr>
      m_storeOutputNodeNames;  //! Do not persistify
#endif
