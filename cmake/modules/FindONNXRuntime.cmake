...
# Optionally, you can set an ONNX root directory here to help cmake find the library
...
if (PC_ONNXRuntime_FOUND)
    set(ONNXRuntime_LIBRARY_DIRS ${PC_ONNXRuntime_LIBRARY_DIRS})
    set(ONNXRuntime_INCLUDE_DIRS ${PC_ONNXRuntime_INCLUDE_DIRS})
else()
    set(ONNXRuntime_LIBRARY_DIRS ${ONNXRuntime_ROOT_DIR})
    set(ONNXRuntime_INCLUDE_DIRS ${ONNXRuntime_ROOT_DIR})
endif()

find_library(
    ONNXRuntime_LIBRARY
    NAMES onnxruntime
    PATHS ${ONNXRuntime_LIBRARY_DIRS}
...
find_path(
    ...
    PATH_SUFFIXES onnxruntime include include/onnxruntime onnxruntime/core/session include/onnxruntime/core/session
)
