...
layer_dict = {
    0: "PreSamplerB", 1: "EMB1", 2: "EMB2", 3: "EMB3", 4: "PreSamplerE", 
    5: "EME1", 6: "EME2", 7: "EME3", 8: "HEC0", 9: "HEC1", 10: "HEC2", 
    11: "HEC3", 12: "TileBar0", 13: "TileBar1", 14: "TileBar2", 15: "TileGap1", 
    16: "TileGap2", 17: "TileGap3", 18: "TileExt0", 19: "TileExt1", 20: "TileExt2", 
...
def plotATLASCaloLayers(input_layer_csv:str):
    ...
    for layer in range(len(atlas_calo_layers)):
        ...
        plt.plot(zValues/1000, rValues/1000, marker, markersize=2, label=atlas_calo_layers[layer].name)
